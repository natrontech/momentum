...
export type RepositoriesResponse<Texpand = unknown> = Required<RepositoriesRecord> &
    BaseSystemFields<Texpand>;
export type RepositoryCredentialsResponse = Required<RepositoryCredentialsRecord> &
    BaseSystemFields;

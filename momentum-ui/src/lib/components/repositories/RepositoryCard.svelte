...
<div class="card rounded-md border-2 transition-all duration-300 ease-in-out hover:shadow-lg
  {
  ...
  <div class="flex">
    ...
    >
        ...
        <div class="flex flex-col justify-center items-center ">
          ...
          <RefreshCw class="text-white group-hover:rotate-180 transition-all duration-300 ease-in-out" />
    ...
    <div class="flex flex-col justify-center items-center w-full relative ">
      ...
      <a href={"/repositories/" + repository.id} class="absolute right-2 top-2">
        <Settings2 class="text-gray-900 hover:rotate-180 transition-all duration-150 ease-in-out" />
      </a>
    </div>
  </div>
</div>

<script lang="ts">
  ...
  import { buildBasePath } from "$lib/components/client-factories/client-factory";
...
<div class="">
  ...
  <a href="{buildBasePath(repository)}swagger/index.html">{buildBasePath(repository)}swagger/index.html</a>
</div>
